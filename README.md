IMPORTANT:
In order to function, you need to download "Default Cards" from https://scryfall.com/docs/api/bulk-data . Add it to the same folder this program is running in, and make sure it's named "default-cards.json".
